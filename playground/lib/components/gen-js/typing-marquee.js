var TypingMarquee = React.createClass({displayName: "TypingMarquee",
  propTypes: {
  ...
  render: function() {
    ...
    return (
      React.createElement("span", {style: props.style}, message, React.createElement("span", {className: "cursor"}, props.cursorCharacter))
    )
  }
});
